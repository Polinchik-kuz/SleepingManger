"""
Конфигурация pytest и общие фикстуры для тестов обфусцированного кода.
"""
import pytest
import sys
...
# Добавляем путь к обфусцированному коду
dist_app_path = Path(__file__).parent.parent / "dist" / "app"
sys.path.insert(0, str(dist_app_path))
